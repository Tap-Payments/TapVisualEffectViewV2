#
#  Be sure to run `pod spec lint TapVisualEffectViewV2.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "UIVisualEffectView wrapper with support of Reduce Transparency Accessibility feature.UIVisualEffectView wrapper with support of Reduce Transparency Accessibility feature."

  spec.homepage     = "https://github.com/Tap-Payments/TapVisualEffectViewV2"
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/TapVisualEffectViewV2.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "TapVisualEffectViewV2/TapVisualEffectViewV2/Source/**/*.{h,m,swift}"
